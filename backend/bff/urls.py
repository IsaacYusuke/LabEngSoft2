...
urlpatterns = [
    ...
    path("logout/", LogoutView.as_view(actions={"get": "get"})),
    path(
        "register/",
        UserView.as_view(
    ...
    path(
        "patient/patients_from_professional_id/<int:pk>/",
        PatientView.as_view(actions={"get": "list_patients_from_professional_id"}, patient_service=PatientService()),
    ),
]
